...
class pred_model:
    def __init__(self):
        with tf.device('/cpu:0'):
            ...
            # cell declaration
            enc_cell = self.__lstm_cell(2048, 2, 0) #expressive power
            ...
            #TODO:my
            fut_logit = tf.reshape(fut_norm, [s[0], s[1], 64 * 64 * 1])
            fut_logit = tf.greater(fut_logit, 0.)
    ...
    def __lstm_cell(self, cell_dim, num_multi_cells, idx):
        ...
        #TODO:new
        cells = [rnn.ConvLSTMCell([None, 64, 64, 1], [5, 5], use_peepholes=True, forget_bias=0.,
